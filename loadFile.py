...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le.setGeometry(QtCore.QRect(180, 110, 201, 20))
        self.le.setObjectName(_fromUtf8("le"))
        self.btn = QtGui.QPushButton(self.centralwidget)
        self.btn.setGeometry(QtCore.QRect(180, 50, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Click to load file:", None))
        self.label_2.setText(_translate("MainWindow", "Load Status:", None))
        self.btn.setText(_translate("MainWindow", "Load", None))
